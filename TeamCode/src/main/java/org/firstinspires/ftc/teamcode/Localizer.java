...
public class Localizer {
    ...
    public void update() {
        ...
        deltaAngle = (right.deltaRaw * 0.9975 - left.deltaRaw) * turnScalingFactor;

        double absoluteAngle = wrapAngle((right.totalDeltaRaw  * 0.9975 - left.totalDeltaRaw) * turnScalingFactor + lastResetAngle);
