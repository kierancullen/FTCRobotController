...
public class Localizer {
    ...
    public void update() {
        ...
        deltaAngle = (right.deltaRaw * 0.995 - left.deltaRaw) * turnScalingFactor;

        double absoluteAngle = wrapAngle((right.totalDeltaRaw  * 0.995 - left.totalDeltaRaw) * turnScalingFactor + lastResetAngle);
